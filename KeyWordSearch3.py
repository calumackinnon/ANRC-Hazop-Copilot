...
AllPDFNamesWithExtension = glob.glob("*.pdf")

PDFNameIndex = 0

for PDFName in AllPDFNamesWithExtension:
    
    pdf_file_name = AllPDFNamesWithExtension[PDFNameIndex]
    # pdf_file_name = 'D:\\Users\\mjb20106\\Documents\\GitHub\\ANRC-Hazop-Copilot\\cnss-tast-gd-11.1.pdf'  # "cnss-tast-gd-11.1.pdf"
    # pdf_file_name = 'cnss-tast-gd-11.1.pdf'  # "cnss-tast-gd-11.1.pdf"
    ...
    for sentence in term_sentences:
        ...
        for page_num, page_text in page_text_list:
            if sentence in page_text:
                ...
                table_dict['File Name'].append(pdf_file_name)
